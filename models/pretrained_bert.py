...
class PretrainedBert():
    def __init__(self):
        ...
        self.model = ClassificationModel('bert', 'bert-base-uncased', use_cuda=False, num_labels=5, args={'max_seq_length':1000, 'logging_steps': 1, 'train_batch_size':128, 'num_train_epochs':1})
